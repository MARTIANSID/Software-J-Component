...
app.get('/generate', function (req, res) {
  var jarPath = path.join(__dirname, '/src/RunUMLPareser.jar');
  var zipPath = path.join(__dirname, '/uploads/' + fileName);
  console.log(__dirname)
  // var path="D:\Software Project\uml-parser\class-diagram-gen\src\RunUMLPareser.java"
  var d = new Date();
  var umlOutputFileName = 'class-diagram-' + d.getTime();
//   var child = require('child_process').spawn(
//     'java', [ jarPath, 'argument to pass in']
