...
import com.uml.parser.JavaParser;
import  java.parse.ParseException;
...
public class ParseJava {
	...
	private void createUMLMethods(UMLClass umlClass, BodyDeclaration body, boolean isConstructor){
		...
		if(isConstructor){
			...
			umlMethod.setModifier(umlClassinn.isInterface() ? Modifiers.PUBLIC_ABSTRACT.modifier : method.getModifiers());
